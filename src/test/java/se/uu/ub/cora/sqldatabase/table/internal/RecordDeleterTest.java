...
import se.uu.ub.cora.sqldatabase.table.internal.RecordDeleterImp;

public class RecordDeleterTest {

	private DataUpdaterSpy dataUpdater;
	private RecordDeleterImp recordDeleter;
	...
	public void testDeleteOneRecordOneCondition() {
		...
		assertEquals(dataUpdater.sql, "delete from organisation where organisation_id = ?");
